...
<body>
	...
	<h1 style="color: whitesmoke; padding: 30px; font-size: 80px;">
		<center><br>._. Furry ._.</center>
	</h1>

	<!-- link to action files -->
	<?php 
	require('../actions/showallpostsAction.php');
	require('../actions/postopinionAction.php');
	require('../actions/deletepostAction.php'); 
	require('../actions/getpostwhithin24hAction.php');
	?>
